...
@section('page_content')
    <div class="page-header">
        ...
        <div class="paginator">
            {{-- previous --}}
            <a href="{{ $students->previousPageUrl() }}" title="Previous" @if ($students->onFirstPage()) class="disabled" @endif>
            ...
            @for ($i = 1; $i <= $students->lastPage(); $i++)
                <a href="{{ $students->url($i) }}" @if ($i == $students->currentPage()) class="active" @endif>{{ $i }}</a>
            @endfor
            {{-- next --}}
            <a href="{{ $students->nextPageUrl() }}" title="Next" @if ($students->onLastPage()) class="disabled" @endif>
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
        ...
        <table>
            ...
            <tbody>
                @foreach ($students as $student)
                    <tr>
                        <td>
                            <a href="/administration/students/{{ $student->id }}">
